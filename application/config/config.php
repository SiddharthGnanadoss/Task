...
|
*/
$config['base_url']	= 'http://'.$_SERVER['SERVER_NAME']."/poll";
...
|
*/
$config['encryption_key'] = '19713007Casablanca24082009Helsinki';
...
*/
$config['proxy_ips'] = '';
$config['site_title'] = 'Polling System';
//$ark_root="http://localhost/contact";
//$config['base_url']	= $ark_root;
define('SITE_TITLE', 'Polling System');
define('BEGIN_PATH', $config['base_url']);
define('HTTP_CSS_PATH', $config['base_url'].'/assets');
define('HTTP_CSS_PATH2', $config['base_url'].'/');
