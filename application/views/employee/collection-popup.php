...
<form class="form-horizontal row-border" id="validate-1" method="post" action="<? echo BEGIN_PATH ?>/leads/view">
...
<div class="form-group"><label class="col-md-4 control-label" for="email">Area</label>
<div class="col-lg-8"><input type="text" id="area" name="area" value="" class="form-control" required="">
</div>
</div>
