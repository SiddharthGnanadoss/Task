...
<td style="text-align:center;"><span class="label label-primary" style="font-size:12px;">&#8377; <?=$value['pending_amount']?></span></td>
<td style="text-align:center;"><span class="label label-success" style="font-size:12px;">&#8377; <?=$value['paid_amount']?></span></td>
<td style="text-align:center;"><span class="label label-danger" style="font-size:12px;">&#8377; <?=$value['remaining_amount']?></span></td>
