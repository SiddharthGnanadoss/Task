                ...
                <div class="row">
					<div class="col-md-12">
						<div class="widget box">
							...
							<form class="form-horizontal" action="<? echo BEGIN_PATH ?>/teamlead/assigntoemp" method="post">
...
<div class="form-group">
<label class="col-md-4 control-label" for="account">Employee<small class="red"></small> </label>
<div class="col-lg-8">

                                         <select name="employee_id" id="employee_id" class="form-control" id="choseReport" required>
