...
?>
		...
		<div id="content">
					...
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i>Role - Edit</h4>
								
							</div>
							<div class="widget-content">
                            
								<form class="form-horizontal row-border" id="validate-1" method="post" enctype="multipart/form-data" action="<? echo BEGIN_PATH ?>/role/update" autocomplete="off">
							
                                    
									<div class="form-group">
										<label class="col-md-2 control-label">Role :</label>
										<div class="col-md-8"><input type="text" name="role" id="role" value="<?=$content[0]['role']?>"  class="form-control"></div>
									</div>
			...
			&nbsp; <a href="<? echo BEGIN_PATH ?>/role"><input type="button" name="add" class="btn btn-lg btn-primary" value="Cancel"></a>					
										
                                        </div>
									</div>
									
									<input type="hidden" name="rid" value="<?=$content[0]['id']?>">
