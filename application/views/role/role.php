...
<a href="<? echo BEGIN_PATH ?>/role/add"><button class="btn btn-primary">Add Role</button></a>
...
?> 
	...
	<ul class="table-controls">
	  	...
	  	<li><a href="<? echo BEGIN_PATH ?>/role/edit/?rid=<?=$value['id']?>" class="bs-tooltip" title="" data-original-title="Edit"><i class="icon-pencil"></i></a> </li>
	    <li></li>
	   	<li><a href="<? echo BEGIN_PATH ?>/role/del/?rid=<?=$value['id']?>" onClick="return confirmDelete();" class="bs-tooltip" title="" data-original-title="Delete"><i class="icon-trash"></i></a> </li>
