...
//$baseUrl = 'http://localhost/Total_Breeze/web_upload/img/';

//$baseUrl = 'http://www.pioneers.ps/webupload/editorimg/';
/*$baseUrl = 'https://r6-dallas.webserversystems.com/~newtrend/newtrend-hat/editorupload/';
$baseDir ="/home/newtrend/public_html/newtrend-hat/editorupload/";*/
$baseUrl = '/ckfinder/userfiles/';
$baseDir = resolveUrl($baseUrl);
// resolveUrl($baseUrl);

/*$baseUrl = "http://173.254.52.94/~aaronsw3/upload/"; 
$baseDir  = "/home6/aaronsw3/public_html/upload/";*/
//echo "basedir".$baseDir; exit;
/*
 * ### Advanced Settings
 */
